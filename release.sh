...
RELEASE_ASSET_NAME=${BINARY_NAME}_${INPUT_GOOS}-${INPUT_GOARCH}
...
GOFLAGS="-buildvcs=${INPUT_BUILDVCS}" GOOS=${INPUT_GOOS} GOARCH=${INPUT_GOARCH} go build -o ${BUILD_ARTIFACTS_FOLDER}/${BINARY_NAME}${EXT} ${INPUT_BUILD_FLAGS} ${LDFLAGS_PREFIX} "${INPUT_LDFLAGS}"
